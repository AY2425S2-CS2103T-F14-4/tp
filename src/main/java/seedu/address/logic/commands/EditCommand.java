...
public class EditCommand extends Command {
    ...
    /**
     * Constructs an EditCommand to edit the specified contact.
     *
     * @param index Index of the contact in the filtered list.
    ...
    /**
     * Creates and returns an updated {@code Person} based on {@code personToEdit} and
     * the fields in {@code editPersonDescriptor}.
     */
